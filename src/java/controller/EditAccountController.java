...
public class EditAccountController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("issell")!=null &&request.getParameter("pass")!=null && request.getParameter("id")!=null&&request.getParameter("user")!=null&&request.getParameter("pass")!=null) {
                    AcountDBContext adb = new AcountDBContext();
            if (        adb.updateAccount(account)) {
